...
func (c *CustomerServiceClientImpl) XXX_InterfaceName() string {
	return "com.jeongen.fastmall.customer.CustomerService"
}
...
func (c *customerServiceClient) CreateCustomer(ctx context.Context, in *CreateCustomerRequest, opts ...grpc_go.CallOption) (*CreateCustomerResponse, common.ErrorWithAttachment) {
	out := new(CreateCustomerResponse)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/CreateCustomer", in, out)
}
...
func (s *UnimplementedCustomerServiceServer) XXX_ServiceDesc() *grpc_go.ServiceDesc {
	return &CustomerService_ServiceDesc
}
...
func _CustomerService_CreateCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
	...
	invo := invocation.NewRPCInvocation("CreateCustomer", args, invAttachment)
	if interceptor == nil {
...
// CustomerService_ServiceDesc is the grpc_go.ServiceDesc for CustomerService service.
// It's only intended for direct use with grpc_go.RegisterService,
// and not to be introspected or modified (even as a copy)
var CustomerService_ServiceDesc = grpc_go.ServiceDesc{
	ServiceName: "com.jeongen.fastmall.customer.CustomerService",
